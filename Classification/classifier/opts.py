...
def model_opts(parser):
    ...
    group.add_argument('-filter_num', type=int, default=128,
                       help='filter_num of CNN')

    # 
    group.add_argument('-rnn_type', type=str, default='LSTM',
                       choices=['LSTM', 'GRU', 'SRU'],
                       help="""The gate type to use in the RNNs""")
    group.add_argument('-cls_arch', type=str, default='single',
                       choices=['single', 'double', 'exdouble', 'pairwise'],
                       help="""The gate type to use in the RNNs""")
    group.add_argument('-score_fn_type', type=str, default='MLP',
                       choices=['MLP', 'LR', 'DUAL'],
                       help="""The gate type to use in the RNNs""")
    
    # extended features for ExtendedDoubleArch 
    group.add_argument('-bilinear_flag', action='store_true',
                       help="""adding bilinear features of pair inputs
                       .""")
    group.add_argument('-dot_flag', action='store_true',
                       help="""adding element-wised dot features of pair inputs
                       .""")
    group.add_argument('-substract_flag', action='store_true',
                       help="""adding element-wised substract features of pair inputs
                       .""")
    group.add_argument('-inner_prod_flag', action='store_true',
                       help="""adding inner-product features of pair inputs
                       .""")

    group.add_argument('-cls_type', type=str, default='MLP',
                       choices=['MLP', 'Dot'],
                       help="""The gate type to use in the RNNs""")
    ...
    group.add_argument('-class_num', type=int, default=2,
                       help='class number ')
...
def test_opts(parser):
    ...
    group.add_argument('-model_from', default='', type=str,
                       help="""If training from a checkpoint then this is the
                       path to the pretrained model's state_dict.""")
